...
<head>
    ...
    <title>AdminLTE 3 | Peduli Diri</title>
        ...
        <aside class="main-sidebar elevation-4" style="background-image: linear-gradient(to top,#2193b0,#d9f5ff);">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    {{-- <div class="image">
                        <img src="{{ asset('dist/img/unnamed.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block" style="font-size: 20px">Peduli Diri</a>
                    </div> --}}
                </div>
